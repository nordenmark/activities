...
class Styles {
  // Colors
  static Color borderColor = CupertinoColors.lightBackgroundGray;
  static Color overlayBgColor = CupertinoColors.white;
  static Color mainBgColor = CupertinoColors.extraLightBackgroundGray;
  static Color primaryColor = CupertinoColors.activeBlue;

  // Text
  static Color textColorNormal = CupertinoColors.systemGrey;
  static Color textColorLight = CupertinoColors.inactiveGray;
